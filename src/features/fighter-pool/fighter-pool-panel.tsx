...
type PoolState = {
  ...
  match: null | { id: string; status: string; opponent: string; code: string; expiresAt: string; serverAddress: string | null; serverPort: number | null; checkedIn: boolean; canCancel: boolean };
};
